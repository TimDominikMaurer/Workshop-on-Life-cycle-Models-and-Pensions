...
moments_diff(ConsumptionData,S)
...
result = optimize(x -> smm_objective(x, ConsumptionData,S, nothing), [0.9,2.1], NelderMead())
...
# Con1, A1 = SimLCM(para,1)

# # The true parameters are
# para.β = 0.98
# para.ρ = 2.0
# plot(Con1')
# Con2, A1 = SimLCM(para,1)
